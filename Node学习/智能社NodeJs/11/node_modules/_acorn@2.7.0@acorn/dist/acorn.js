    ...
    return (function e(t, n, r) {
        ...
        1: [function(_dereq_, module, exports) {
            ...
            pp.parseNew = function() {
                ...
                if (this.eat(_tokentype.types.parenL)) node.arguments = this.parseExprList(_tokentype.types.parenR, false);
            ...
            pp.parsePropertyValue = function(prop, isPattern, isGenerator, startPos, startLoc, refDestructuringErrors) {
                if (this.eat(_tokentype.types.colon)) {
                    ...
                    if (prop.value.params.length !== paramCount) {
                        ...
                        else this.raise(start, "setter should have exactly one param");
                    }
            ...
            pp.parseExprList = function(close, allowTrailingComma, allowEmpty, refDestructuringErrors) {
                ...
                while (!this.eat(close)) {
                    ...
                    var elt = undefined;
                    if (allowEmpty && this.type === _tokentype.types.comma) elt = null;
                    else if (this.type === _tokentype.types.ellipsis) elt = this.parseSpread(refDestructuringErrors);
        ...
        }, { "./expression": 1, "./identifier": 2, "./location": 4, "./locutil": 5, "./lval": 6, "./node": 7, "./options": 8, "./parseutil": 9, "./state": 10, "./statement": 11, "./tokencontext": 12, "./tokenize": 13, "./tokentype": 14, "./whitespace": 16 }],
        ...
        6: [function(_dereq_, module, exports) {
            ...
            pp.parseRest = function(allowNonIdent) {
                ...
                if (allowNonIdent) node.argument = this.type === _tokentype.types.name ? this.parseIdent() : this.unexpected();
                else node.argument = this.type === _tokentype.types.name || this.type === _tokentype.types.bracketL ? this.parseBindingAtom() : this.unexpected();
            ...
            pp.parseBindingList = function(close, allowEmpty, allowTrailingComma, allowNonIdent) {
                ...
                while (!this.eat(close)) {
                    ...
                    else this.expect(_tokentype.types.comma);
        ...
        11: [function(_dereq_, module, exports) {
            ...
            pp.parseStatement = function(declaration, topLevel) {
                ...
                switch (starttype) {
                    ...
                    default:
                        ...
                        if (starttype === _tokentype.types.name && expr.type === "Identifier" && this.eat(_tokentype.types.colon)) return this.parseLabeledStatement(node, maybeName, expr);
            ...
            pp.parseBreakContinueStatement = function(node, keyword) {
                ...
                this.next();
                if (this.eat(_tokentype.types.semi) || this.insertSemicolon()) node.label = null;
                else if (this.type !== _tokentype.types.name) this.unexpected();
                else {
            ...
            pp.parseDoStatement = function(node) {
                ...
                if (this.options.ecmaVersion >= 6) this.eat(_tokentype.types.semi);
                else this.semicolon();
            ...
            pp.parseReturnStatement = function(node) {
                ...
                if (this.eat(_tokentype.types.semi) || this.insertSemicolon()) node.argument = null;
                else {
        ...
        12: [function(_dereq_, module, exports) {
            ...
            pp.updateContext = function(prevType) {
                var update = undefined,
                    type = this.type;
                if (type.keyword && prevType == _tokentype.types.dot) this.exprAllowed = false;
