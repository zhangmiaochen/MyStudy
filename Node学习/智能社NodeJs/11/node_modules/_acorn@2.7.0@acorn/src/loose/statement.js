...
lp.parseStatement = function() {
    ...
    switch (starttype) {
        ...
        case tt._switch:
            let blockIndent = this.curIndent,
...
lp.parseClass = function(isStatement) {
    ...
    node.body.body = []
    this.pushCx()
    let indent = this.curIndent + 1,
        line = this.curLineStart
    this.eat(tt.braceL)
    if (this.curIndent + 1 < indent) { indent = this.curIndent;
        line = this.curLineStart }
    while (!this.closes(tt.braceR, indent, line)) {
        ...
        if (isDummy(method.key)) { if (isDummy(this.parseMaybeAssign())) this.next();
